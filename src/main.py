...
calcular_e_gerar_graficos(caminho_base_itub4, 'ITUB4', 1, '2023-08-25', '2024-08-25', 'doc/ITUB4sg_1ano.xlsx')
calcular_e_gerar_graficos(caminho_base_itub4, 'ITUB4', 3, '2021-03-29', '2024-03-29', 'doc/ITUB4sg_3anos.xlsx')
calcular_e_gerar_graficos(caminho_base_itub4, 'ITUB4', 5, '2019-05-15', '2024-05-15', 'doc/ITUB4sg_5anos.xlsx')
...
calcular_e_gerar_graficos(caminho_base_lren3, 'LREN3', 5, '2019-06-22', '2024-06-22', 'doc/LREN3sg_5anos.xlsx')
