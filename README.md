...
Para o gerenciamento de dependências e ambientes foi utilizado a biblioteca [Poetry](https://python-poetry.org/) e para facilitar o controle de versões e desenvolvimento colaborativo o projeto está disponível no Github.
